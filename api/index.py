# FastAPI Backend for EasyFind — Supabase Multi-Tenant (Vercel Serverless)
...
# ============================================================
# LIFESPAN (no scheduler on Vercel serverless)
# ============================================================

@asynccontextmanager
async def lifespan(app: FastAPI):
    # Startup
    logging.info("🚀 Starting EasyFind Backend (Vercel Serverless)")
    # Scheduler disabled on Vercel serverless - use external cron
    yield
    # Shutdown
...
# ============================================================
# AUTOPILOT / BACKGROUND JOBS (manual trigger via cron)
# ============================================================
